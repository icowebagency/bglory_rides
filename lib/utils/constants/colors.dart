...
class TColors {
  ...
  static const Color accent = Color(0xFFDFF0E9);
  ...
  // Link Color
  static const Color linkBlueColor = Color(0xFF4b68ff);
  static const Color linkRedColor = Color(0xFFFF0000);

  // Error and validation colors
  static const Color error = Color(0xFFCB3333);
