...
class TripToDestinationBottomSheet extends StatefulWidget {
  ...
  @override
  State<TripToDestinationBottomSheet> createState() =>
      _TripToDestinationBottomSheetState();
}

class _TripToDestinationBottomSheetState
    extends State<TripToDestinationBottomSheet> {
