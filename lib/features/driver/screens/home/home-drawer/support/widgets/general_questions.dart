...
class GeneralQuestionsScreens extends StatefulWidget {
  const GeneralQuestionsScreens({super.key});

  @override
  State<GeneralQuestionsScreens> createState() =>
      _GeneralQuestionsScreensState();
}

class _GeneralQuestionsScreensState extends State<GeneralQuestionsScreens> {
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              ...
              TTexts.driverFaqGeneralQuestionsHeader,
                ...
                child: Column(
                  ...
                  children: [
                    ListTile(
                      ...
                      title: Text(
                        TTexts.driverFaqGeneralQuestionsTitle,
                        style: Theme.of(context).textTheme.titleLarge,
                      ),
                      subtitle: Column(
                        ...
                        children: [
                          ...
                          _buildBulletPoint(
                              TTexts.driverFaqGeneralQuestionsOne),
                          _buildBulletPoint(
                              TTexts.driverFaqGeneralQuestionsTwo),
                        ],
                      ),
                    ),
                    const SizedBox(
                    ...
                    ListTile(
                      ...
                      title: Text(
                        TTexts.driverFaqGeneralQuestionsTitleTwo,
                        style: Theme.of(context).textTheme.titleLarge,
                      ),
                      subtitle: Column(
                        mainAxisAlignment: MainAxisAlignment.center,
                        ...
                        children: [
                          const SizedBox(height: 5),
                          _buildBulletPoint(
                              TTexts.driverFaqGeneralQuestionsHOneTwo),
                          _buildBulletPoint(
                              TTexts.driverFaqGeneralQuestionsTwoTwo),
                        ],
                      ),
                    ),
                  ],
