...
class PaymentAndEarningsScreen extends StatefulWidget {
  const PaymentAndEarningsScreen({super.key});

  @override
  State<PaymentAndEarningsScreen> createState() =>
      _PaymentAndEarningsScreenState();
}

class _PaymentAndEarningsScreenState extends State<PaymentAndEarningsScreen> {
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ListTile(
                      ...
                      title: Text(
                        TTexts.faqPaymentAndEarningsTwoTitle,
                        style: Theme.of(context).textTheme.titleLarge,
                      ),
                      subtitle: Column(
                        mainAxisAlignment: MainAxisAlignment.center,
                        ...
                        children: [
                          const SizedBox(height: 5),
                          _buildBulletPoint(TTexts.faqPaymentAndEarningsTwoOne),
                          _buildBulletPoint(TTexts.faqPaymentAndEarningsTwoTwo),
                          _buildBulletPoint(
                              TTexts.faqPaymentAndEarningsTwoThree),
                        ],
                      ),
                    ),
                  ],
