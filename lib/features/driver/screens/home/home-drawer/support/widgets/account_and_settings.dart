        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              ...
              TTexts.driverFaqAccountAndSettingsHeader,
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ListTile(
                      leading: Text(
                        TTexts.driverFaqAccountAndSettingsNumber,
                        style: Theme.of(context).textTheme.titleLarge,
                      ),
                      title: Text(
                        TTexts.driverFaqAccountAndSettingsTitleOne,
                        style: Theme.of(context).textTheme.titleLarge,
                      ),
                      subtitle: Column(
                        ...
                        children: [
                          ...
                          _buildBulletPoint(
                              TTexts.driverFaqAccountAndSettingsOne),
                          _buildBulletPoint(
                              TTexts.driverFaqAccountAndSettingsTwo),
                          _buildBulletPoint(
                              TTexts.driverFaqAccountAndSettingsThree),
                          _buildBulletPoint(
                              TTexts.driverFaqAccountAndSettingsFour),
                        ],
                      ),
                    ),
                    const SizedBox(
                    ...
                    ListTile(
                      ...
                      title: Text(
                        TTexts.driverFaqAccountAndSettingsTitleTwo,
                        style: Theme.of(context).textTheme.titleLarge,
                      ),
                      subtitle: Column(
                        mainAxisAlignment: MainAxisAlignment.center,
                        ...
                        children: [
                          const SizedBox(height: 5),
                          _buildBulletPoint(
                              TTexts.driverFaqAccountAndSettingsOneTwo),
                          _buildBulletPoint(
                              TTexts.driverFaqAccountAndSettingsTwoTwo),
                          _buildBulletPoint(
                              TTexts.driverFaqAccountAndSettingsThreeTwo),
                        ],
                      ),
                    ),
                  ],
