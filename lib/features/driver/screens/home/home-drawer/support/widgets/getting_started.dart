        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              ...
              TTexts.faqGettingStartedHeader,
                ...
                child: Column(
                  ...
                  children: [
                    ListTile(
                      ...
                      title: Text(
                        TTexts.faqGeneralQuestionsDriverSignup,
                        style: Theme.of(context).textTheme.titleLarge,
                      ),
                      subtitle: Column(
                        ...
                        children: [
                          ...
                          _buildBulletPoint(TTexts.usingTheAppOne),
                          _buildBulletPoint(TTexts.usingTheAppTwo),
                          _buildBulletPoint(TTexts.usingTheAppThree),
                          _buildBulletPoint(TTexts.usingTheAppFour),
                          _buildBulletPoint(TTexts.usingTheAppFive),
                          _buildBulletPoint(TTexts.usingTheAppSix),
                        ],
                      ),
                    ),
                    const SizedBox(
                    ...
                    ListTile(
                      leading: Text(
                        TTexts.faqGeneralQuestionsNumberTwo,
                        style: Theme.of(context).textTheme.titleLarge,
                      ),
                      title: Text(
                        TTexts.faqRequirementsHeader,
                        style: Theme.of(context).textTheme.titleLarge,
                      ),
                      subtitle: Column(
                        mainAxisAlignment: MainAxisAlignment.center,
                        ...
                        children: [
                          const SizedBox(height: 5),
                          _buildBulletPoint(TTexts.requirementsOne),
                          _buildBulletPoint(TTexts.requirementsTwo),
                          _buildBulletPoint(TTexts.requirementsThree),
                          _buildBulletPoint(TTexts.requirementsFour),
                          _buildBulletPoint(TTexts.requirementsFive),
                        ],
                      ),
                    ),
                  ],
