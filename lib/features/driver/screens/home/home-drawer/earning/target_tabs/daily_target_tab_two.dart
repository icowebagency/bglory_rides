...
class DailyTargetTabTwo extends StatefulWidget {
  const DailyTargetTabTwo({super.key});

  @override
  State<DailyTargetTabTwo> createState() => _DailyTargetTabTwoState();
}

class _DailyTargetTabTwoState extends State<DailyTargetTabTwo> {
