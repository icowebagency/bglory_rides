...
class DriverMotorcycleHackneyPermitPictureScreen extends StatefulWidget {
  ...
  @override
  State<DriverMotorcycleHackneyPermitPictureScreen> createState() =>
      _DriverMotorcycleHackneyPermitPictureScreenState();
}

class _DriverMotorcycleHackneyPermitPictureScreenState
    extends State<DriverMotorcycleHackneyPermitPictureScreen> {
  File? photo;
          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                ...
                Text(
                  TTexts.driverMotorcyleHackneyRules,
