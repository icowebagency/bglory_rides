import 'package:bglory_rides/features/rider/screens/home/rider_home_drawer/support/faq_screen_component.dart';
...
class RiderFaqsScreen extends StatefulWidget {
  const RiderFaqsScreen({super.key});

  @override
  State<RiderFaqsScreen> createState() => _RiderFaqsScreenState();
}

class _RiderFaqsScreenState extends State<RiderFaqsScreen> {
                ...
                child: Column(
                  children: [
                    FaqScreenComponent(
                      ...
                      faqOnTap: () {
                        context.push(BGRiderRouteNames.riderFaqDetailScreen);
                      },
                    ),
                    FaqScreenComponent(
